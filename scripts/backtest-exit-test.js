...
const CONFIG = {
  ...
  targetSpread: parseFloat(process.argv[5]) || 0.5, // Allow exit target as 5th parameter
  minHoldMs: 5 * 60 * 1000,
...
async function run() {
  console.log(`\nBacktest: ${CONFIG.minEntrySpread}% entry, ${CONFIG.targetSpread}% exit, ${CONFIG.lookbackDays} days lookback\n`);
